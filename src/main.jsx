...
function App() {
  ...
  <div className="grid">
    ...
    <article className="card">
      ...
      <section id="contacts" className="contacts"><div><p className="over">Контакти</p><h2>Звернутися по правову допомогу</h2><p>Опишіть ситуацію коротко: хто звертається, яка справа, який суд або орган, які документи є, який результат потрібен.</p></div><div className="contactList">

<a href="tel:+380682307757">
  <Phone/>
  <span>
    <small>Телефон</small>
    <b>068 230 77 57</b>
...
<a href="mailto:kibalnykvova@gmail.com">
  <Mail/>
  <span>
    <small>E-mail</small>
    <b>kibalnykvova@gmail.com</b>
  </span>
</a>
...
<div>
  <MapPin/>
  <span>
    <small>Робоче місце адвоката</small>
    <b>Волинська область, Володимирський район, с. Заріччя</b>
    <br/>
    <small>Прийом за попереднім записом</small>
  </span>
</div>
...
<div>
  <MapPin/>
  <span>
    <small>Територія роботи</small>
    <b>Представництво інтересів клієнтів по всій Україні</b>
  </span>
</div>

<a
  href="https://maps.google.com/?q=Заріччя+Володимирський+район+Волинська+область"
  target="_blank"
  rel="noreferrer"
>
  <MapPin/>
  <span>
    <small>Карта</small>
    <b>Показати розташування</b>
  </span>
</a>

<a href="https://t.me/advokat_kibalnyk" target="_blank" rel="noreferrer">
  <MessageCircle/>
  <span>
    <small>Telegram</small>
    <b>Написати повідомлення</b>
  </span>
</a>
