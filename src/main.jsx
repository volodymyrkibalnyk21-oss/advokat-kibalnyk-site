...
function App() {
  ...
  <p className="over">Юридична допомога</p>

  <h2>Військовий адвокат та захист прав громадян</h2>

  <p className="muted">
    Адвокат Кібальник Володимир Павлович надає правову допомогу у військових,
    кримінальних, адміністративних та цивільних справах. Допомога з ТЦК,
    ВЛК, оскарженням незаконних рішень, підготовкою позовів, скарг,
    клопотань та процесуальних документів.
  </p>

  <div className="grid">
    <article className="card">
      <h3>Адвокат по ТЦК</h3>
      <p>Оскарження дій ТЦК, супровід військовослужбовців та захист прав громадян.</p>
    </article>

    <article className="card">
      <h3>Військовий адвокат</h3>
      <p>Рапорти, ВЛК, звільнення зі служби, захист військовослужбовців.</p>
    </article>

    <article className="card">
      <h3>Адвокат Волинь</h3>
      <p>Представництво інтересів клієнтів у судах та державних органах.</p>
    </article>
  </div>
